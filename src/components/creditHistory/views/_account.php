...
<div class="row" style="margin-bottom: 10px;border-bottom: 1px solid #000000;border-top: 1px solid #000000; text-align: center">
    <div class="col-md-4">
...
<div class="row" style="margin-bottom: 10px;border-bottom: 1px solid #000000;border-top: 1px solid #000000; text-align: center">
    ...
    <div class="col-md-4">
        <div class="row" style="height: 100%">
            ...
            <div class="col-md-4" ><?= Yii::$app->formatter->asDecimal((float)$model->creditLimit - (float)$model->principalOutstanding, 2) ?></div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="row" style="height: 100%">
...
<div class="row" style="margin-bottom: 10px;border-bottom: 1px solid #000000;border-top: 1px solid #000000; text-align: center">
    ...
    <div class="col-md-4">
        <div class="row" style="height: 100%">
            ...
            <div class="col-md-6" ><?= Yii::$app->formatter->asDate($model->interestPaymentDueDate, 'dd.MM.yyyy') ?></div>
        </div>
    </div>
</div>
<div class="row" style="margin-bottom: 10px;border-bottom: 1px solid #000000;border-top: 1px solid #000000; text-align: center">
