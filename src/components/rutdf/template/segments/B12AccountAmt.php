 ...
 */
class B12AccountAmt extends BaseSegment
{
    /**
     * @var AccountAmtRUTDF
     */
    ...
    public function getFields(): array
    {
        return [
            ...
            7 => $this->accountAmt->commitUuid ? $this->accountAmt->commitUuid . "-" . $this->accountAmt->getUuidControlSum(
                    $this->accountAmt->commitUuid
                ) : self::EMPTY_VALUE,
        ];
    }
    ...
    {
        return 'Блок может быть Множественным, если показатель ЮЛ_11.1 = 2, 3, 5 или 99. Если показатель ЮЛ_11.1 = 1 или 4, то блок Единичный дополняемый.';
    }
}