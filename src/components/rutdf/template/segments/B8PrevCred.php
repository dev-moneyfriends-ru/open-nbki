...
class B8PrevCred extends \mfteam\nbch\components\BaseSegment
{
    ...
    public function getFieldsDescriptions(): array
    {
        return [
            ...
            'Полное наименование лица, от которого перешли права и обязанности' => 'Не заполняется',
            'Регистрационный номер лица, от которого перешли права и обязанности' => 'Не заполняется',
        ];
    }
