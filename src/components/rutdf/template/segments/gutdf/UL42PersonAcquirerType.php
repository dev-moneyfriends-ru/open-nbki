...
/**
 * Class representing UL42PersonAcquirerType
 *
 * Блок 42. Сведения о приобретателе прав – физическом лице
 * XSD Type: UL_42_PersonAcquirer_Type
 */
class UL42PersonAcquirerType
{
    /**
     * 42.1. Фамилия
     *
     ...
     *
     * @var \mfteam\nbch\components\rutdf\template\segments\gutdf\UL42PersonAcquirerType\TaxNumGroupUL42PersonAcquirerAType[] $taxNumGroupUL42PersonAcquirer
     */
    private $taxNumGroupUL42PersonAcquirer = [
    ...
    /**
     * Adds as taxNumGroupUL42PersonAcquirer
     *
     * Номер налогоплательщика
     *
     * @param \mfteam\nbch\components\rutdf\template\segments\gutdf\UL42PersonAcquirerType\TaxNumGroupUL42PersonAcquirerAType $taxNumGroupUL42PersonAcquirer
     *@return self
     */
    public function addToTaxNumGroupUL42PersonAcquirer(\mfteam\nbch\components\rutdf\template\segments\gutdf\UL42PersonAcquirerType\TaxNumGroupUL42PersonAcquirerAType $taxNumGroupUL42PersonAcquirer)
    {
        $this->taxNumGroupUL42PersonAcquirer[] = $taxNumGroupUL42PersonAcquirer;
        return $this;
    }

    /**
     * isset taxNumGroupUL42PersonAcquirer
     *
     * Номер налогоплательщика
     *
     ...
     * @return bool
     */
    public function issetTaxNumGroupUL42PersonAcquirer($index)
    {
        return isset($this->taxNumGroupUL42PersonAcquirer[$index]);
    }

    /**
     * unset taxNumGroupUL42PersonAcquirer
     *
     * Номер налогоплательщика
     *
     * @param int|string $index
     * @return void
     */
    public function unsetTaxNumGroupUL42PersonAcquirer($index)
    {
        unset($this->taxNumGroupUL42PersonAcquirer[$index]);
    }

    /**
     * Gets as taxNumGroupUL42PersonAcquirer
     *
     * Номер налогоплательщика
     *
     * @return \mfteam\nbch\components\rutdf\template\segments\gutdf\UL42PersonAcquirerType\TaxNumGroupUL42PersonAcquirerAType[]
     */
    public function getTaxNumGroupUL42PersonAcquirer()
    {
        return $this->taxNumGroupUL42PersonAcquirer;
    }

    /**
     * Sets a new taxNumGroupUL42PersonAcquirer
     *
     * Номер налогоплательщика
     *
     * @param \mfteam\nbch\components\rutdf\template\segments\gutdf\UL42PersonAcquirerType\TaxNumGroupUL42PersonAcquirerAType[] $taxNumGroupUL42PersonAcquirer
     * @return self
     */
    public function setTaxNumGroupUL42PersonAcquirer(array $taxNumGroupUL42PersonAcquirer = null)
    {
        $this->taxNumGroupUL42PersonAcquirer = $taxNumGroupUL42PersonAcquirer;
        return $this;
    }
