...
/**
 * Class representing FL42SourceLiquidationType
 *
 * Блок 42. Сведения об обязательстве, если источник находится в процессе ликвидации
 * XSD Type: FL_42_SourceLiquidation_Type
 */
class FL42SourceLiquidationType
{
    /**
    ...
    /**
     * 42.7. Признак перехода прав кредитора к другому лицу = 0
     *
    ...
    /**
     * 42.7. Признак перехода прав кредитора к другому лицу = 1
     *
    ...
    /**
     * 42.8. Признак прекращения обязательства = 0
     *
    ...
    /**
     * 42.8. Признак прекращения обязательства = 1
     *
