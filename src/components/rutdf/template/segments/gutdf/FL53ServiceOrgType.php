...
/**
 * Class representing FL53ServiceOrgType
 *
 * Блок 53. Сведения об обслуживающей организации
 * XSD Type: FL_53_ServiceOrg_Type
 */
class FL53ServiceOrgType
{
    /**
     * 53.1. Признак регистрации в Российской Федерации = 0
     *
    ...
    /**
     * 53.1. Признак регистрации в Российской Федерации = 1
     *
     ...
     *
     * @var \mfteam\nbch\components\rutdf\template\segments\gutdf\FL53ServiceOrgType\TaxNumGroupFL53ServiceOrgAType[] $taxNumGroupFL53ServiceOrg
     */
    private $taxNumGroupFL53ServiceOrg = [
    ...
    /**
     * Adds as taxNumGroupFL53ServiceOrg
     *
     * Номер налогоплательщика
     *
     * @param \mfteam\nbch\components\rutdf\template\segments\gutdf\FL53ServiceOrgType\TaxNumGroupFL53ServiceOrgAType $taxNumGroupFL53ServiceOrg
     *@return self
     */
    public function addToTaxNumGroupFL53ServiceOrg(\mfteam\nbch\components\rutdf\template\segments\gutdf\FL53ServiceOrgType\TaxNumGroupFL53ServiceOrgAType $taxNumGroupFL53ServiceOrg)
    {
        $this->taxNumGroupFL53ServiceOrg[] = $taxNumGroupFL53ServiceOrg;
        return $this;
    }

    /**
     * isset taxNumGroupFL53ServiceOrg
     *
     * Номер налогоплательщика
     *
     ...
     * @return bool
     */
    public function issetTaxNumGroupFL53ServiceOrg($index)
    {
        return isset($this->taxNumGroupFL53ServiceOrg[$index]);
    }

    /**
     * unset taxNumGroupFL53ServiceOrg
     *
     * Номер налогоплательщика
     *
     * @param int|string $index
     * @return void
     */
    public function unsetTaxNumGroupFL53ServiceOrg($index)
    {
        unset($this->taxNumGroupFL53ServiceOrg[$index]);
    }

    /**
     * Gets as taxNumGroupFL53ServiceOrg
     *
     * Номер налогоплательщика
     *
     * @return \mfteam\nbch\components\rutdf\template\segments\gutdf\FL53ServiceOrgType\TaxNumGroupFL53ServiceOrgAType[]
     */
    public function getTaxNumGroupFL53ServiceOrg()
    {
        return $this->taxNumGroupFL53ServiceOrg;
    }

    /**
     * Sets a new taxNumGroupFL53ServiceOrg
     *
     * Номер налогоплательщика
     *
     * @param \mfteam\nbch\components\rutdf\template\segments\gutdf\FL53ServiceOrgType\TaxNumGroupFL53ServiceOrgAType[] $taxNumGroupFL53ServiceOrg
     * @return self
     */
    public function setTaxNumGroupFL53ServiceOrg(array $taxNumGroupFL53ServiceOrg = null)
    {
        $this->taxNumGroupFL53ServiceOrg = $taxNumGroupFL53ServiceOrg;
        return $this;
    }
