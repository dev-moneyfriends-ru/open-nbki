...
class ULEvent23Type extends EventDataType
{
     ...
     * Блок 28. Сведения о возмещении принципалом гаранту выплаченной суммы
     *
     * @param UL28WarrantyReturnType $uL28WarrantyReturn
     * @return self
     */
    public function setUL28WarrantyReturn(?UL28WarrantyReturnType $uL28WarrantyReturn = null)
    {
