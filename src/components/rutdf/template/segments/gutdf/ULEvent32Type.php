...
class ULEvent32Type extends EventDataType
{
    ...
    /**
     * Конкурсное производство в отношении источника. Права кредитора по обязательству перешли к другому лицу
     *
    ...
    /**
     * Процесс ликвидации источника. Права кредитора по обязательству перешли к другому лицу
     *
    ...
    public function getProperties(): array
    {
        ...
        $properties[] = 'changeReason';
        $properties[] = 'startDate';
        return $properties;
    }
    protected function initAttributes()
    {
        $this->setStartDate($this->formatDate($this->sendData->getStartDate()));
        $this->setChangeReason($this->sendData->getChangeReason());
