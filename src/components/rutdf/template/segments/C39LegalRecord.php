...
/**
 * Блок 39. Сведения о судебном споре или требовании по обязательству – C39_LEGALRECORD
 */
class C39LegalRecord extends BaseSegment
{
    /**
     * @var LegalItemsRUTDF
     */
    ...
    {
        return 'По показателям 39.2–39.6 указываются сведения о судебном акте, которым заканчивается рассмотрение дела по существу';
    }
    ...
    {
        return 'Блок 39. Сведения о судебном споре или требовании по обязательству – C39_LEGALRECORD';
    }
}