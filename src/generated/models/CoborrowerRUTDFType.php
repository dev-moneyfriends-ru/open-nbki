...
/**
 * Class representing CoborrowerRUTDFType
 *
 * 
 * XSD Type: CoborrowerRUTDF
 */
class CoborrowerRUTDFType
{

    /**
     * @var int $hasSolidary
     */
    private $hasSolidary = null;

    /**
     * @var int $solidaryNum
     */
    private $solidaryNum = null;
     ...
     * @return int
     */
    public function getHasSolidary()
    {
        return $this->hasSolidary;
    }

    /**
     * Sets a new hasSolidary
     *
     * @param int $hasSolidary
     * @return self
     */
    public function setHasSolidary($hasSolidary)
    {
        $this->hasSolidary = $hasSolidary;
        return $this;
    }
     ...
     * @return int
     */
    public function getSolidaryNum()
    {
        return $this->solidaryNum;
    }

    /**
     * Sets a new solidaryNum
     *
     * @param int $solidaryNum
     * @return self
     */
    public function setSolidaryNum($solidaryNum)
    {
        $this->solidaryNum = $solidaryNum;
        return $this;
    }
