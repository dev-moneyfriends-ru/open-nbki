...
class Consent extends Model
{
    ...
    /**
     * Цель согласия. Кредитный мониторинг в рамках действующего договора
     */
    public const PURPOSE_MONITOR = 23;
    ...
    /**
     * Срок действия согласия в течение 6 месяцев со дня оформления;
     */
    public const PERIOD_MONTH = 1;
    
    /**
     * Срок действия согласия в течение 1 года со дня оформления;
     */
    public const PERIOD_YEAR = 2;
    
    /**
     * Срок действия согласия в течение срока действия согласия с субъектом КИ
     * были заключены договор займа (кредита), договор лизинга, договор залога,
     * договор поручительства, выдана независимая гарантия.
     */
    public const PERIOD_OFFER = 2;
    ...
    public static function consentPurposeList()
    {
        return [
            ...
            self::PURPOSE_MONITOR => 'Кредитный мониторинг в рамках действующего договора',
        ];
    }
