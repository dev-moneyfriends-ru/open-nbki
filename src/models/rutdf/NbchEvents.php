...
class NbchEvents
{
    ...
    public static function list()
    {
        return [
            ...
            self::EVENT_1_2 => '1.2 Источник одобрил обращение субъекта (направил ему оферту) или изменились сведения об обращении',
            self::EVENT_1_3 => '1.3 Источник отказался от совершения сделки по обращению субъекта',
            ...
            self::EVENT_2_2 => '2.2 Субъекту передана сумма займа (кредита) либо субъект стал принципалом по гарантии или поручителем по сделке, кроме договора лизинга для денежного обязательства',
    ...
    public static function personBlocks()
    {
        return [
            ...
            self::EVENT_2_2 => [
                1, 2, 3, 4, 5, 6, 7, 17, 18, 19, 21, 22, 24, 25, 26, 27, 28, 29, 56,
            ],
            self::EVENT_2_3_1 => [
            ...
            self::EVENT_2_5_1 => [
                1, 2, 3, 4, 5, 6, 7, 17, 18, 19, 21, 22, 24, 25, 26, 27, 28, 29, 38, 56,
            ],
            self::EVENT_2_5_2 => [
                1, 2, 3, 4, 5, 6, 7, 17, 18, 31, 38, 56,
            ],
            self::EVENT_2_6 => [
                1, 2, 3, 4, 5, 6, 7, 17, 39,
            ],
