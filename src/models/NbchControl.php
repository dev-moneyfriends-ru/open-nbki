 ...
 * @property-read NbchTutdfRequest[] $requests
 */
class NbchControl extends ActiveRecord
{
    ...
    /**
     * @return array|NbchControl|ActiveRecord|null
     */
    public function getFirstUncheckedRequest()
    {
        return $this->getUncheckedRequests()->orderBy(['createdAt' => SORT_ASC])->one();
    }
     ...
     *
     * @return ActiveQuery|NbchTutdfRequestQuery
     */
    ...
    {
        return new NbchControlQuery(get_called_class());
    }
}
