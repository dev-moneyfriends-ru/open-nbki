...
class Trade extends BaseItem
{
    ...
    /**
     * Заполняется, в случае если по показателю 54.1 «Признак учета обязательства» указан код «0».
     * Сумма обязательства, которая учтена на внебалансовых счетах источника.
     * @var float
     */
    public $offbalanceAmt = 0;
    ...
    public function requiredRules()
    {
        return [
            ...
            [
                ...
                'required',
                'when' => function(Trade $trade){
                    return $trade->obligAccountCode === 0;
                }
            ],
            [
                [
