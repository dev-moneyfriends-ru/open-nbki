 ...
 * @property-read string $offerUuid
 */
class NbchConsent extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['consentPurpose', 'in', 'range' => array_keys(ConsentReq::consentPurposeList())],
    ...
    {
        return new NbchConsentQuery(static::class);
    }
    ...
    {
        return ArrayHelper::getValue(ConsentReq::consentPurposeList(), $this->consentPurpose);
    }
