...
class InformationPartReplyRUTDF extends BaseInformationPartReplyRUTDF
{
    ...
    public $loanSum = null;
    /**
     * Валюта одобренного займа (кредита), лизинга или
     * обеспечения
     * @var null|string
     */
    public $loanCurrency = 'RUB';
    /**
     * Признак подачи обращения с использованием
     * финансовой платформы.
     * Код «1» ‒ в случае если обращение подано с использованием финансовой платформы в соответствии с 211-ФЗ «О совершении финансовых сделок с использованием финансовой платформы» или через лиц, действующих от имени и (или) по поручению потребителя финансовых услуг в целях обеспечения возможности совершения финансовых сделок или получения предложений о совершении финансовых сделок с финансовыми организациями;
     * код «0» – в случае если обстоятельство кода «1» отсутствует.
     * @var int|null
     */
    public $platformExist = null;
